PRIVATE int get_MAINNAME0(pk_compound* pk,Node** first,Node** last,double *value,int V1, int V2, CONST_INT){
...
PRIVATE int get_MAINNAME1(pk_compound *pk,Node** first,Node** last,double *value,int V1, int V2, CONST_INT){
    int MAINNAME1 = INT_VALUE_NAME;
