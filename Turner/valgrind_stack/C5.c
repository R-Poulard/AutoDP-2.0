...
int get_M(HashTable *hashTable,Node** first,Node** last,int * value,int m,int n,int r,int t);

int compute_M(HashTable *hashTable,Node** first,Node** last,int m,int n,int r,int t);

void backtrace_M(HashTable *hashTable,int score,int m,int n,int r,int t) ;

int get_L(HashTable *hashTable,Node** first,Node** last,int * value,int i,int k,int o,int p);

int compute_L(HashTable *hashTable,Node** first,Node** last,int i,int k,int o,int p);

void backtrace_L(HashTable *hashTable,int score,int i,int k,int o,int p) ;

int get_K(HashTable *hashTable,Node** first,Node** last,int * value,int i,int k,int n,int p);

int compute_K(HashTable *hashTable,Node** first,Node** last,int i,int k,int n,int p);

void backtrace_K(HashTable *hashTable,int score,int i,int k,int n,int p) ;

int get_J(HashTable *hashTable,Node** first,Node** last,int * value,int a,int h,int k,int n,int p);

int compute_J(HashTable *hashTable,Node** first,Node** last,int a,int h,int k,int n,int p);

void backtrace_J(HashTable *hashTable,int score,int a,int h,int k,int n,int p) ;

int get_I(HashTable *hashTable,Node** first,Node** last,int * value,int b,int e,int g,int k,int l);

int compute_I(HashTable *hashTable,Node** first,Node** last,int b,int e,int g,int k,int l);

void backtrace_I(HashTable *hashTable,int score,int b,int e,int g,int k,int l) ;

int get_H(HashTable *hashTable,Node** first,Node** last,int * value,int c,int e,int q,int r);

int compute_H(HashTable *hashTable,Node** first,Node** last,int c,int e,int q,int r);

void backtrace_H(HashTable *hashTable,int score,int c,int e,int q,int r) ;

int get_G(HashTable *hashTable,Node** first,Node** last,int * value,int c,int e,int p,int r);

int compute_G(HashTable *hashTable,Node** first,Node** last,int c,int e,int p,int r);

void backtrace_G(HashTable *hashTable,int score,int c,int e,int p,int r) ;

int get_F(HashTable *hashTable,Node** first,Node** last,int * value,int b,int e,int p,int r);

int compute_F(HashTable *hashTable,Node** first,Node** last,int b,int e,int p,int r);

void backtrace_F(HashTable *hashTable,int score,int b,int e,int p,int r) ;

int get_E(HashTable *hashTable,Node** first,Node** last,int * value,int b,int g,int k,int l,int p,int r);

int compute_E(HashTable *hashTable,Node** first,Node** last,int b,int g,int k,int l,int p,int r);

void backtrace_E(HashTable *hashTable,int score,int b,int g,int k,int l,int p,int r) ;

int get_D0(HashTable *hashTable,Node** first,Node** last,int * value,int a, int h, int k,int l,int p,int r);

int get_D1(HashTable *hashTable,Node** first,Node** last,int * value,int a, int h, int k,int l,int p,int r);

int compute_D1(HashTable *hashTable,Node** first,Node** last,int a, int h, int k,int l,int p,int r);
...
int get_C(HashTable *hashTable,Node** first,Node** last,int * value,int a,int l,int n,int r);

int compute_C(HashTable *hashTable,Node** first,Node** last,int a,int l,int n,int r);

void backtrace_C(HashTable *hashTable,int score,int a,int l,int n,int r) ;

int get_B(HashTable *hashTable,Node** first,Node** last,int * value,int a,int m,int n,int r);

int compute_B(HashTable *hashTable,Node** first,Node** last,int a,int m,int n,int r);
        ...
        switch(topTuple->values[0]){
            ...
            break;//Clique
             ...
             case 77:
                 ...
                 if(compute_M(hasTable,&add_on_first,&add_on_last,m,n,r,t)==1){
             ...
             case 76:
                 ...
                 if(compute_L(hasTable,&add_on_first,&add_on_last,i,k,o,p)==1){
             ...
             case 75:
                 ...
                 if(compute_K(hasTable,&add_on_first,&add_on_last,i,k,n,p)==1){
             ...
             case 74:
                 ...
                 if(compute_J(hasTable,&add_on_first,&add_on_last,a,h,k,n,p)==1){
             ...
             case 73:
                 ...
                 if(compute_I(hasTable,&add_on_first,&add_on_last,b,e,g,k,l)==1){
             ...
             case 72:
                 ...
                 if(compute_H(hasTable,&add_on_first,&add_on_last,c,e,q,r)==1){
             ...
             case 71:
                 ...
                 if(compute_G(hasTable,&add_on_first,&add_on_last,c,e,p,r)==1){
             ...
             case 70:
                 ...
                 if(compute_F(hasTable,&add_on_first,&add_on_last,b,e,p,r)==1){
             ...
             case 69:
                 ...
                 if(compute_E(hasTable,&add_on_first,&add_on_last,b,g,k,l,p,r)==1){
             ...
             case 68:
                 ...
                 if(compute_D1(hasTable,&add_on_first,&add_on_last,a,h,k,l,p,r)==1){
             ...
             case 67:
                 ...
                 if(compute_C(hasTable,&add_on_first,&add_on_last,a,l,n,r)==1){
             ...
             case 66:
                 ...
                 if(compute_B(hasTable,&add_on_first,&add_on_last,a,m,n,r)==1){
...
int compute_M(HashTable *hashTable,Node** first,Node** last,int m,int n,int r,int t) {
    ...
    for (int s=r;s<t;s++) {
      ...
      int tmp0;
      if(get_CLIQUE0( hashTable,first,last,&tmp0,m,n-1,s,t-1)==0){possible=0;}
...
int compute_L(HashTable *hashTable,Node** first,Node** last,int i,int k,int o,int p) {
    ...
    for (int j=i+1;j<k+1;j++) {
      ...
      int tmp0;
      if(get_CLIQUE0( hashTable,first,last,&tmp0,i,j-1,o,p-1)==0){possible=0;}
      else if(tmp0==INT_MAX){continue;}
...
int compute_K(HashTable *hashTable,Node** first,Node** last,int i,int k,int n,int p) {
    ...
    for (int o=n;o<p;o++) {
      ...
      int tmp0;
      if(get_L( hashTable,first,last,&tmp0,i,k,o,p)==0){possible=0;}
      else if(tmp0==INT_MAX){continue;}
...
int compute_J(HashTable *hashTable,Node** first,Node** last,int a,int h,int k,int n,int p) {
    ...
    for (int i=h;i<k;i++) {
      ...
      int tmp0;
      if(get_K( hashTable,first,last,&tmp0,i,k,n,p)==0){possible=0;}
      else if(tmp0==INT_MAX){continue;}
...
int compute_H(HashTable *hashTable,Node** first,Node** last,int c,int e,int q,int r) {
    ...
    for (int d=c+1;d<e+1;d++) {
      ...
      int tmp0;
      if(get_CLIQUE0( hashTable,first,last,&tmp0,c,d-1,q,r-1)==0){possible=0;}
      else if(tmp0==INT_MAX){continue;}
...
int compute_G(HashTable *hashTable,Node** first,Node** last,int c,int e,int p,int r) {
    ...
    for (int q=p;q<r;q++) {
      ...
      int tmp0;
      if(get_H( hashTable,first,last,&tmp0,c,e,q,r)==0){possible=0;}
      else if(tmp0==INT_MAX){continue;}
...
int compute_F(HashTable *hashTable,Node** first,Node** last,int b,int e,int p,int r) {
    ...
    for (int c=b;c<e;c++) {
      ...
      int tmp0;
      if(get_G( hashTable,first,last,&tmp0,c,e,p,r)==0){possible=0;}
      else if(tmp0==INT_MAX){continue;}
...
int compute_E(HashTable *hashTable,Node** first,Node** last,int b,int g,int k,int l,int p,int r) {
    ...
    for (int e=b+1;e<g;e++) {
      ...
      int tmp0;
      if(get_F( hashTable,first,last,&tmp0,b,e,p,r)==0){possible=0;}
      else if(tmp0==INT_MAX){continue;}
      int tmp1;
      if(get_I( hashTable,first,last,&tmp1,b,e,g,k,l)==0){possible=0;}
...
int compute_D1(HashTable *hashTable,Node** first,Node** last,int a, int h, int k,int l,int p,int r) {
    ...
    int tmp0;
    if(get_E( hashTable,first,last,&tmp0,a,h+1,k,l,p,r)==0){possible=0;}
    ...
    for(int tmp1=a;tmp1<=min(h-1,INT_MAX);tmp1++){
        for(int tmp2=max(INT_MIN,tmp1+3);tmp2<=h;tmp2++){
            if(evaluate(tmp1,tmp2) && tmp1-tmp2+1<=THETA){
                ...
                if(tmp3!=INT_MAX){
                    int tmp;
                    if(get_D1(hashTable,first,last,&tmp,tmp1+1,tmp2-1,k,l,p,r)==0){
                        possible=0;
                    }
                    if(possible==1){
                        //printf("C1 res= %d",tmp);
    ...
    for (int h=a+4;h<l-1;h++) {
        for (int k=h+1;k<l;k++) {
            for (int p=n+1;p<r;p++) {
              ...
              int tmp0;
              if(get_D0( hashTable,first,last,&tmp0,a,h-1,k,l,p,r)==0){possible=0;}
              else if(tmp0==INT_MAX){continue;}
              int tmp1;
              if(get_J( hashTable,first,last,&tmp1,a,h,k,n,p)==0){possible=0;}
              else if(tmp1==INT_MAX){continue;}
...
int compute_B(HashTable *hashTable,Node** first,Node** last,int a,int m,int n,int r) {
    ...
    for (int l=a+6;l<m+1;l++) {
      ...
      int tmp0;
      if(get_C( hashTable,first,last,&tmp0,a,l,n,r)==0){possible=0;}
      else if(tmp0==INT_MAX){continue;}
    ...
    for (int m=a+6;m<t-3;m++) {
        for (int n=m+1;n<t-2;n++) {
            for (int r=n+2;r<t;r++) {
              ...
              int tmp0;
              if(get_B( hashTable,first,last,&tmp0,a,m,n,r)==0){possible=0;}
              else if(tmp0==INT_MAX){continue;}
              int tmp1;
              if(get_M( hashTable,first,last,&tmp1,m,n,r,t)==0){possible=0;}
              else if(tmp1==INT_MAX){continue;}
...
void backtrace_M(HashTable *hashTable,int score,int m,int n,int r,int t) {
    ...
    for (int s=r;s<t;s++) {
      ...
      int tmp0;
      get_CLIQUE0( hashTable,NULL,NULL,&tmp0,m,n-1,s,t-1);
...
void backtrace_L(HashTable *hashTable,int score,int i,int k,int o,int p) {
    ...
    for (int j=i+1;j<k+1;j++) {
      ...
      int tmp0;
      get_CLIQUE0( hashTable,NULL,NULL,&tmp0,i,j-1,o,p-1);
      if(tmp0==INT_MAX){continue;}
...
void backtrace_K(HashTable *hashTable,int score,int i,int k,int n,int p) {
    ...
    for (int o=n;o<p;o++) {
      ...
      int tmp0;
      get_L( hashTable,NULL,NULL,&tmp0,i,k,o,p);
      if(tmp0==INT_MAX){continue;}
...
void backtrace_J(HashTable *hashTable,int score,int a,int h,int k,int n,int p) {
    ...
    for (int i=h;i<k;i++) {
      ...
      int tmp0;
      get_K( hashTable,NULL,NULL,&tmp0,i,k,n,p);
      if(tmp0==INT_MAX){continue;}
...
void backtrace_H(HashTable *hashTable,int score,int c,int e,int q,int r) {
    ...
    for (int d=c+1;d<e+1;d++) {
      ...
      int tmp0;
      get_CLIQUE0( hashTable,NULL,NULL,&tmp0,c,d-1,q,r-1);
      if(tmp0==INT_MAX){continue;}
...
void backtrace_G(HashTable *hashTable,int score,int c,int e,int p,int r) {
    ...
    for (int q=p;q<r;q++) {
      ...
      int tmp0;
      get_H( hashTable,NULL,NULL,&tmp0,c,e,q,r);
      if(tmp0==INT_MAX){continue;}
...
void backtrace_F(HashTable *hashTable,int score,int b,int e,int p,int r) {
    ...
    for (int c=b;c<e;c++) {
      ...
      int tmp0;
      get_G( hashTable,NULL,NULL,&tmp0,c,e,p,r);
      if(tmp0==INT_MAX){continue;}
...
void backtrace_E(HashTable *hashTable,int score,int b,int g,int k,int l,int p,int r) {
    ...
    for (int e=b+1;e<g;e++) {
      ...
      int tmp0;
      get_F( hashTable,NULL,NULL,&tmp0,b,e,p,r);
      if(tmp0==INT_MAX){continue;}
      int tmp1;
      get_I( hashTable,NULL,NULL,&tmp1,b,e,g,k,l);
...
void backtrace_D0(HashTable *hashTable, int score, int a, int h, int k,int l,int p,int r) {
    ...
    int tmp;
    get_D1(hashTable,NULL,NULL,&tmp,a+1,h-1,k,l,p,r);
    int sc=INTB(a,h,-1,-1);
    if(score==add(sc,tmp)){
        backtrace_INTB(sc,a,h,-1,-1);
...
void backtrace_D1(HashTable *hashTable, int score, int a, int h, int k,int l,int p,int r) {
    ...
    int tmp0;
    get_E( hashTable,NULL,NULL,&tmp0,a,h+1,k,l,p,r);
    ...
    for(int tmp1=a;tmp1<=min(h-1,INT_MAX);tmp1++){
        for(int tmp2=max(INT_MIN,tmp1+3);tmp2<=h;tmp2++){
            if(evaluate(tmp1,tmp2) && tmp1-tmp2+1<=THETA){
                ...
                if(tmp3!=INT_MAX){
                    int tmp0;
                    get_D1(hashTable,NULL,NULL,&tmp0,tmp1+1,tmp2-1,k,l,p,r);
    ...
    for (int h=a+4;h<l-1;h++) {
        for (int k=h+1;k<l;k++) {
            for (int p=n+1;p<r;p++) {
              ...
              int tmp0;
              get_D0( hashTable,NULL,NULL,&tmp0,a,h-1,k,l,p,r);
              if(tmp0==INT_MAX){continue;}
              int tmp1;
              get_J( hashTable,NULL,NULL,&tmp1,a,h,k,n,p);
              if(tmp1==INT_MAX){continue;}
...
void backtrace_B(HashTable *hashTable,int score,int a,int m,int n,int r) {
    ...
    for (int l=a+6;l<m+1;l++) {
      ...
      int tmp0;
      get_C( hashTable,NULL,NULL,&tmp0,a,l,n,r);
      if(tmp0==INT_MAX){continue;}
    ...
    for (int m=a+6;m<t-3;m++) {
        for (int n=m+1;n<t-2;n++) {
            for (int r=n+2;r<t;r++) {
              ...
              int tmp0;
              get_B( hashTable,NULL,NULL,&tmp0,a,m,n,r);
              if(tmp0==INT_MAX){continue;}
              int tmp1;
              get_M( hashTable,NULL,NULL,&tmp1,m,n,r,t);
              if(tmp1==INT_MAX){continue;}
