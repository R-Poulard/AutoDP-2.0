...
int get_I(HashTable *hashTable,Node** first,Node** last,int * value,int i,int j,int n,int p);

int compute_I(HashTable *hashTable,Node** first,Node** last,int i,int j,int n,int p);

void backtrace_I(HashTable *hashTable,int score,int i,int j,int n,int p) ;

int get_H(HashTable *hashTable,Node** first,Node** last,int * value,int a,int b,int g,int i);

int compute_H(HashTable *hashTable,Node** first,Node** last,int a,int b,int g,int i);

void backtrace_H(HashTable *hashTable,int score,int a,int b,int g,int i) ;

int get_G(HashTable *hashTable,Node** first,Node** last,int * value,int e,int f,int l,int n);

int compute_G(HashTable *hashTable,Node** first,Node** last,int e,int f,int l,int n);

void backtrace_G(HashTable *hashTable,int score,int e,int f,int l,int n) ;

int get_F(HashTable *hashTable,Node** first,Node** last,int * value,int d,int f,int l,int n);

int compute_F(HashTable *hashTable,Node** first,Node** last,int d,int f,int l,int n);

void backtrace_F(HashTable *hashTable,int score,int d,int f,int l,int n) ;

int get_E(HashTable *hashTable,Node** first,Node** last,int * value,int c,int d,int j,int l);

int compute_E(HashTable *hashTable,Node** first,Node** last,int c,int d,int j,int l);

void backtrace_E(HashTable *hashTable,int score,int c,int d,int j,int l) ;

int get_D(HashTable *hashTable,Node** first,Node** last,int * value,int c,int f,int j,int n);

int compute_D(HashTable *hashTable,Node** first,Node** last,int c,int f,int j,int n);

void backtrace_D(HashTable *hashTable,int score,int c,int f,int j,int n) ;

int get_C(HashTable *hashTable,Node** first,Node** last,int * value,int b,int g,int j,int n);

int compute_C(HashTable *hashTable,Node** first,Node** last,int b,int g,int j,int n);

void backtrace_C(HashTable *hashTable,int score,int b,int g,int j,int n) ;

int get_B(HashTable *hashTable,Node** first,Node** last,int * value,int a,int i,int j,int n);

int compute_B(HashTable *hashTable,Node** first,Node** last,int a,int i,int j,int n);
        ...
        switch(topTuple->values[0]){
            ...
            break;//Clique
             ...
             case 73:
                 ...
                 if(compute_I(hasTable,&add_on_first,&add_on_last,i,j,n,p)==1){
             ...
             case 72:
                 ...
                 if(compute_H(hasTable,&add_on_first,&add_on_last,a,b,g,i)==1){
             ...
             case 71:
                 ...
                 if(compute_G(hasTable,&add_on_first,&add_on_last,e,f,l,n)==1){
             ...
             case 70:
                 ...
                 if(compute_F(hasTable,&add_on_first,&add_on_last,d,f,l,n)==1){
             ...
             case 69:
                 ...
                 if(compute_E(hasTable,&add_on_first,&add_on_last,c,d,j,l)==1){
             ...
             case 68:
                 ...
                 if(compute_D(hasTable,&add_on_first,&add_on_last,c,f,j,n)==1){
             ...
             case 67:
                 ...
                 if(compute_C(hasTable,&add_on_first,&add_on_last,b,g,j,n)==1){
             ...
             case 66:
                 ...
                 if(compute_B(hasTable,&add_on_first,&add_on_last,a,i,j,n)==1){
...
int compute_H(HashTable *hashTable,Node** first,Node** last,int a,int b,int g,int i) {
    ...
    for (int h=g+1;h<i+1;h++) {
      ...
      int tmp0;
      if(get_CLIQUE0( hashTable,first,last,&tmp0,a,b-1,g,h-1)==0){possible=0;}
      if(tmp0==INT_MAX){continue;}
...
int compute_F(HashTable *hashTable,Node** first,Node** last,int d,int f,int l,int n) {
    ...
    for (int e=d;e<f;e++) {
      ...
      int tmp0;
      if(get_G( hashTable,first,last,&tmp0,e,f,l,n)==0){possible=0;}
      if(tmp0==INT_MAX){continue;}
...
int compute_D(HashTable *hashTable,Node** first,Node** last,int c,int f,int j,int n) {
    ...
    for (int d=c+1;d<f;d++) {
        for (int l=j+1;l<n;l++) {
          ...
          int tmp0;
          if(get_F( hashTable,first,last,&tmp0,d,f,l,n)==0){possible=0;}
          if(tmp0==INT_MAX){continue;}
          int tmp1;
          if(get_E( hashTable,first,last,&tmp1,c,d,j,l)==0){possible=0;}
...
int compute_C(HashTable *hashTable,Node** first,Node** last,int b,int g,int j,int n) {
    ...
    for (int c=b;c<g-1;c++) {
      ...
      int mfe0 = MFEFree(b,c-1);
          ...
          int tmp0;
          if(get_D( hashTable,first,last,&tmp0,c,f,j,n)==0){possible=0;}
          if(tmp0==INT_MAX){continue;}
...
int compute_B(HashTable *hashTable,Node** first,Node** last,int a,int i,int j,int n) {
    ...
    for (int b=a+1;b<i-2;b++) {
        for (int g=b+2;g<i;g++) {
          ...
          int tmp0;
          if(get_C( hashTable,first,last,&tmp0,b,g,j,n)==0){possible=0;}
          if(tmp0==INT_MAX){continue;}
          int tmp1;
          if(get_H( hashTable,first,last,&tmp1,a,b,g,i)==0){possible=0;}
          if(tmp1==INT_MAX){continue;}
    ...
    for (int i=a+4;i<p-3;i++) {
        for (int j=i+1;j<p-2;j++) {
            for (int n=j+2;n<p;n++) {
              ...
              int tmp0;
              if(get_B( hashTable,first,last,&tmp0,a,i,j,n)==0){possible=0;}
              if(tmp0==INT_MAX){continue;}
              int tmp1;
              if(get_I( hashTable,first,last,&tmp1,i,j,n,p)==0){possible=0;}
              if(tmp1==INT_MAX){continue;}
...
void backtrace_H(HashTable *hashTable,int score,int a,int b,int g,int i) {
    ...
    for (int h=g+1;h<i+1;h++) {
      ...
      int tmp0;
      get_CLIQUE0( hashTable,NULL,NULL,&tmp0,a,b-1,g,h-1);
      if(tmp0==INT_MAX){continue;}
...
void backtrace_F(HashTable *hashTable,int score,int d,int f,int l,int n) {
    ...
    for (int e=d;e<f;e++) {
      ...
      int tmp0;
      get_G( hashTable,NULL,NULL,&tmp0,e,f,l,n);
      if(tmp0==INT_MAX){continue;}
...
void backtrace_D(HashTable *hashTable,int score,int c,int f,int j,int n) {
    ...
    for (int d=c+1;d<f;d++) {
        for (int l=j+1;l<n;l++) {
          ...
          int tmp0;
          get_F( hashTable,NULL,NULL,&tmp0,d,f,l,n);
          if(tmp0==INT_MAX){continue;}
          int tmp1;
          get_E( hashTable,NULL,NULL,&tmp1,c,d,j,l);
          if(tmp1==INT_MAX){continue;}
...
void backtrace_C(HashTable *hashTable,int score,int b,int g,int j,int n) {
    ...
    for (int c=b;c<g-1;c++) {
      ...
      int mfe0 = MFEFree(b,c-1);
          ...
          int tmp0;
          get_D( hashTable,NULL,NULL,&tmp0,c,f,j,n);
          if(tmp0==INT_MAX){continue;}
...
void backtrace_B(HashTable *hashTable,int score,int a,int i,int j,int n) {
    ...
    for (int b=a+1;b<i-2;b++) {
        for (int g=b+2;g<i;g++) {
          ...
          int tmp0;
          get_C( hashTable,NULL,NULL,&tmp0,b,g,j,n);
          if(tmp0==INT_MAX){continue;}
          int tmp1;
          get_H( hashTable,NULL,NULL,&tmp1,a,b,g,i);
          if(tmp1==INT_MAX){continue;}
    ...
    for (int i=a+4;i<p-3;i++) {
        for (int j=i+1;j<p-2;j++) {
            for (int n=j+2;n<p;n++) {
              ...
              int tmp0;
              get_B( hashTable,NULL,NULL,&tmp0,a,i,j,n);
              if(tmp0==INT_MAX){continue;}
              int tmp1;
              get_I( hashTable,NULL,NULL,&tmp1,i,j,n,p);
              if(tmp1==INT_MAX){continue;}
