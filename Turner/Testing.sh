...
for i in $list; do 
    ...
    echo "Testing $i:";
    gcc /home/remipoul/pwb/Turner/$1/$i.c -o /home/remipoul/pwb/Turner/$1/$i -lm -g 2>> $1/log_build/$i.txt &&  "/home/remipoul/pwb/Turner/$1/"$i "/home/remipoul/pwb/test_sequence/example_${i}_little.txt" > $1/log_test/$i.txt;
