...
int main(int argc, char ** argv) {
    ...
    start_time = clock();
    int size_array[]={499979 ,493579 ,487093 ,480373 ,473951 ,467627 ,460979 ,454277 ,447637 ,441107 ,434563 ,428299 ,421741 ,415273 ,408911 ,402299 ,395597 ,389483 ,382961 ,376463 ,369961 ,363437 ,356933 ,350563 ,344189 ,337697 ,331337 ,325027 ,318823 ,312679 ,306247 ,300149 ,293633 ,287167 ,280871 ,274591 ,268199 ,262147 ,255709 ,249437 ,243421 ,237163 ,230693 ,224683 ,218627 ,212227 ,206279 ,200041 ,193877 ,187861 ,181943 ,175961 ,169889 ,163637 ,157519 ,151553 ,145703 ,139681 ,133781 ,127873 ,122027 ,116167 ,110321 ,104479 ,98689 ,92863 ,87253 ,81509 ,75821 ,70313 ,64667};
    line="AAGGAGACACAGUACAUUCUUCUGAUCAUCUGCAGAUCAGCAAUUAGAAAAGAAAGAUCAGCUACCUCCUUGGGACCUGAUCAUAACACAGGAGCUACCGAUUUCAACUACUCCGGCCUAACU";
    MAX=strlen(line);
    char *ss="...........................................................................................................................";
    createMatrix(MAX,ss);
    preset_N(MAX);

    for(int sz=0;sz<71;sz++){
        for(int rep=0;rep<3;rep++){
            TABLE_SIZE=size_array[sz];
            ...
            float vrna_score=vrna_mfe(fc,NULL);
            ...
            size_t totalSize = sizeof(HashTable) + (hashTable->capacity * sizeof(HashNode *)) + 3*sizeof(int);
            print_table_stat(hashTable);
            printf("%d;%.4f;%d;%d\n",TABLE_SIZE,test_time,hashTable->size,totalSize);
            //end of test
